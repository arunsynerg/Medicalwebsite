...
return(
    ...
    <div className="homepg" name='home'>
        ...
        <div className='homeright'>
            ...
            <p>Discover a comprehensive range of pharmaceuticals, healthcare products, and expert guidance right here. We're committed to serving our community with high-quality medications, health essentials, and personalized care.</p>
             <h1>What We Offer:</h1>
